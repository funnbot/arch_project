...
impl bevy::prelude::Plugin for SimTimePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_schedule(sim_update)
            ...
            .add_systems(
                bevy::prelude::Update,
                run_sim_update_schedule.in_set(MyUpdate::Sim),
            )
            .add_systems(Update, display_sim_update.in_set(MyUpdate::UI))
            .add_systems(SimUpdate, do_something_expensive);
    }
}

fn run_sim_update_schedule(world: &mut World) {
